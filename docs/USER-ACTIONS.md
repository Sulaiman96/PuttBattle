...
- [x] **UA-8 · Watch the verification run** (10 min): the agent drives the MCP-SETUP checklist; you confirm the permission prompts actually appear on the spawn/delete test. *Why you: you're testing the guardrails that protect you from agents.*
